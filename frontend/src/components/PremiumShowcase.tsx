...
function VideoCard({
  ...
  return (
    <div
      ...
      style={style}
    >
      {/* eslint-disable-next-line jsx-a11y/video-has-caption, @next/next/no-img-element */}
      <video
        src={src}
        poster={poster}
        autoPlay
    ...
    <section className="w-full bg-surface px-2 pb-2 transition-colors duration-400">
      <div className="flex w-full flex-col gap-[clamp(1rem,2vw,2rem)] md:flex-row">
        ...
        <div className="premium-card bg-surface-alt flex flex-1 flex-col overflow-hidden transition-colors duration-400">
          {/* Label row — mobile: includes FAB at top-right; desktop: label only */}
          <div className="premium-card-pad mb-3 flex items-center justify-between">
            ...
            {/* FAB — mobile only at top-right */}
            <div className="md:hidden">
              <FabButton />
            </div>
          </div>

          {/* Gallery — edge-to-edge, no horizontal padding */}
          ...
          <div className="premium-card-pad premium-content-text mt-4 md:mt-5">
            ...
            >
              Upload one product and get all the angles, looks and moods
              you need for PDPs and campaigns—without booking a studio.
            </p>
          </div>
        ...
        <div className="premium-card bg-surface-alt flex flex-1 flex-col overflow-hidden transition-colors duration-400">
          ...
          {/* Video area — edge-to-edge, no horizontal padding */}
